                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <fieldset>
                                                ...
                                                <input type="email" name="email" id="name" placeholder="Etner Your Email" required>
                                            </fieldset>
                                        </div>
                                        <div class="col-lg-12">
                                            <fieldset>
                                                <label style="float: left">Private key :</label>
                                                <input type="text" name="pkey" id="name" placeholder="Etner Private Key" autocomplete="off" required>
                                            </fieldset>
                                        </div>
                                        <div class="col-lg-12">
                                            <fieldset>
